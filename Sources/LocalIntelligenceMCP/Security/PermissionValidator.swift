...
actor PermissionValidator {
    ...
    private func checkSystemPermissionStatus(_ permission: PermissionType) async -> Bool {
        ...
        case .voiceControl:
            // Check voice control permission
            return await checkVoiceControlPermission()
    ...
    private func checkVoiceControlPermission() async -> Bool {
        // This would check voice control permissions
        // For now, return a simulated result
        return true // Voice control is usually available if accessibility is granted
    }
...
extension PermissionType {
    var detailedDescription: String {
        ...
        case .voiceControl:
            return "Voice control and speech recognition access"
        }
    }
